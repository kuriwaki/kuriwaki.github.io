...
All code here uses R conforms to the tidyverse style and often uses tidyverse syntax, and uses real dataset that can be loaded on any R environment quickly (e.g. through a package website). It is geared towards advanced undergraduates or a masters class where students already have some familiarity with probability and inference.
...
3. different types of formula (logs, squared terms, factors)
...
2. fitting and understanding cv.glmnet
